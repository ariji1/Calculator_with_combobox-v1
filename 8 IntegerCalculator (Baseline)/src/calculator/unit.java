...
//public class unit {
//	
//	public unit(String operand1, String operand2)
//	{
//		if ()
//		{
//			
...
//	{
//		UnitConverter toKilometers = Dy.getConverterTo(KILOMETER);
//		double km = toKilometers.convert(Measure.valueOf(1,MILE).doubleValue(MILE));
...
//	Map <Integer,unit> units = new HashMap<Integer,u>()
//	{{ put(1,METER);
//		
//		
//		
...
//	units = {"meter",};
	...
	public unit (int unitSpecifier) {
		System.out.println("unit"+unitSpecifier+"name"+unitList[unitSpecifier]);
